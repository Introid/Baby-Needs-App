package com.introid.babyneed.data;
...
import com.introid.babyneed.util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_BABY_TABLE= " CREATE TABLE " + Constants.TABLE_NAME + "(" +
                ...
                Constants.KEY_ITEM_NUMBER + " INTEGER," +
    ...
    public void addItem(Item item){
        ...
        values.put(Constants.KEY_ITEM_NUMBER,item.getItemSize());
    ...
    public Item getItem(int id){
        ...
        if (cursor != null) {
           ...
           item.setItemColor(cursor.getString(cursor.getColumnIndex(Constants.KEY_COLOR)));
            item.setItemSize(cursor.getInt(cursor.getColumnIndex(Constants.KEY_ITEM_NUMBER)));
    ...
    public List<Item> getAllItems(){
        ...
        Cursor cursor= db.query(Constants.TABLE_NAME,new String[]{Constants.KEY_ID,
        Constants.KEY_BABY_ITEM,Constants.KEY_QTY_NUMBER,Constants.KEY_COLOR,
                        Constants.KEY_ITEM_NUMBER,
